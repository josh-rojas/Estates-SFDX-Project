...
| Succession_Contact_Established__c | Succession Contact Established | Checkbox | BRD Contact Cadence: Agent marks this TRUE when verbal contact with successor is made. Used by Flow to stop automated contact cadence and update parent Case.Contact_Established__c. |
