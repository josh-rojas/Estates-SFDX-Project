...
| `SuccessionPathwayEmailSender`   | Invocable Apex for sending pathway selection emails        |
...
### Flow Automations (6 - All Inactive in Source Control)
...
| `Succession_Send_Pathway_Form_Email`       | Would send email with link to public form        |
...
├── classes/              # Apex classes (9 production + 12 test classes)
├── triggers/             # Apex triggers (1: SuccessionCaseTrigger)
├── flows/                # Flow definitions (6 - all Inactive in source)
