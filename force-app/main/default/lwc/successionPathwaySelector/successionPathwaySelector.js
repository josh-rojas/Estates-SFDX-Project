...
export default class SuccessionPathwaySelector extends LightningElement {
  ...
  pathways = [
    {
      ...
      icon: "utility:gift",
      description:
        "Distribute the account balance to qualified charitable organizations",
      details: [
      ...
      bestFor:
        "Honoring the donor's charitable legacy by immediately distributing assets"
    },
    {
      ...
      description:
        "Transfer the account to yourself as a new donor-advised fund",
      details: [
      ...
      bestFor:
        "Continuing the donor's philanthropic mission under your stewardship"
    },
    {
  ...
  handlePathwaySelect(event) {
    ...
    this.dispatchEvent(
      new CustomEvent("pathwayselected", {
        detail: { pathway }
      })
    );
  }
