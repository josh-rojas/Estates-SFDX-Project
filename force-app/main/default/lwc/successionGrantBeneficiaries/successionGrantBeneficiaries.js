...
export default class SuccessionGrantBeneficiaries extends LightningElement {
    ...
    get totalGrantAmount() {
        return this._beneficiaries.reduce((sum, b) => sum + (parseFloat(b.amount) || 0), 0);
    }
    ...
    notifyParent() {
        ...
        const validBeneficiaries = this._beneficiaries.filter(
            b => b.charityName && b.amount && parseFloat(b.amount) >= this.MIN_GRANT_AMOUNT
        );

        this.dispatchEvent(new CustomEvent('beneficiariesupdated', {
